...
const TourGuides = () => {
  const guides = [
    {
      ...
      name: "Elvin Məmmədov",
      description:
        "Bələdçimizlə hər yerdəki təhlükəsiz və əyləncəli keçən təbii marşrutlarını kəşf edin",
    ...
    },
    {
      ...
      name: "Roya Hüseynova",
      description:
        "Bələdçimizlə hər psixoloji səssiyaları rahat və silinmiş keçən, səhri və yolunuzu gələcəsən",
      image: "/Ellipse 8.png",
      rating: 4.9,
      toursIcon: "🧠",
      tours: "100+ Sess",
    ...
    },
    {
      ...
      description:
        "Bələdçimizlə hər yoqa səssiyaları rahat yaşadığı keçən budun və rahatlığını verilməyə",
  ...
  return (
    <section className="min-h-screen py-16 px-5 bg-gradient-to-br ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#33443A] text-base leading-relaxed max-w-[700px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1312w] mx-auto">
          {guides.map((guide) => (
            <div
              key={guide.id}
              className="bg-gradient-to-br from-[#1a2921] to-[#2d3d33] rounded-[20px] p-8 text-center shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
            >
              {/* Guide Image */}
              <div className="w-[192px] h-[192px] mx-auto mb-5 relative">
              ...
              {/* Description */}
              <p className="text-[#c4c4c4] text-[13px] leading-relaxed mb-5 min-h-[60px]">
                {guide.description}
              </p>
              ...
              <div className="flex justify-center gap-4 mb-6 flex-wrap">
                ...
                <div className="flex items-center  gap-1">
                  ...
                  <span className="text-white text-xs">{guide.job}</span>
                </div>
              </div>
