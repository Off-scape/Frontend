          ...
          <div className="grid grid-cols-1  xl:grid-cols-4  lg:grid-cols-2 sm:grid-cols-2 gap-12 items-start ">
            ...
            <div>
              <div className="text-white text-sm leading-[100%] ">
                <span className={`${playfair.className} font-bold`}>OFFSCAPE </span>
                <span className="font-normal">
                  dən son xəbərləri qaçırmayın
                </span>
              </div>
              <div className="border-2 relative border-[#6A6A6D] rounded-[20px]
                w-75 
                sm:w-75 
                lg:w-100
                 h-11 sm:h-12 px-5 py-3.5 flex items-center mt-4">
                <input type="text" placeholder="E-poctunuz burada" className="text-white text-base outline-0 w-3/4 h-full" />
                <div className="absolute right-28 bottom-0 w-px h-full bg-[#6A6A6D]"></div>
                <button className="font-semibold text-base text-white leading-[100%] lg:pl-3 cursor-pointer">Abunə ol</button>
              </div>
              <div className="flex mt-4 w-full 
                ...
                >
                  Qutunu işarələməklə, ən azı 18 yaşınızın olduğunu qəbul edirsiniz.
                </label>
